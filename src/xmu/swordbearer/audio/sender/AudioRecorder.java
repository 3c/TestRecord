...
public class AudioRecorder implements Runnable {
    ...
    public void startRecording() {
        ...
        audioBufSize =
                AudioRecord.getMinBufferSize(AudioConfig.SAMPLERATE, AudioConfig.RECORDER_CHANNEL_CONFIG,
        ...
        if (null == audioRecord) {
            audioRecord =
                    new AudioRecord(AudioConfig.AUDIO_RESOURCE, AudioConfig.SAMPLERATE,
